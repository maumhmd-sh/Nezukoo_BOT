...
let handler = async (m, { conn, participants, groupMetadata }) => {
    ...
    const { isBanned, welcome, detect, sWelcome, sBye, sPromote, sDemote, antiLink, nsfw, onlyLatinos, useDocument } = global.db.data.chats[m.chat]
