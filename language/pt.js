...
const translations = {
    ...
    newcode: (usedPrefix) => `Ótimo! Agora você pode usar *${usedPrefix}serbot* para solicitar um novo código QR`,
    ...
    notext: 'Digite novamente adicionando um text',
    textSe: 'Separe o text com um',
  ...
  langList: 'Selecione o bahasa que deseja usar\n\n≡ *bahasas disponíveis*',
  expire: 'Expira em',
  ping: 'Velocidade',
  uptime: 'Tempo ativo',
  NSgc: (usedPrefix) => `O grupo não permite conteúdo NSFW\nUse este grupo\n${NSgc}\n\nSe você é um administrador, habilite com\n*${usedPrefix}enable* nsfw`,
  ...
  tradList: 'Lista de bahasas compatíveis',
