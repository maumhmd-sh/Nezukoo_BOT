...
def shell():
    ...
    if not args.mini:
        printer('📑 Mengambil daftar server speedtest.net...', quiet)
        try:
        ...
        if args.server and len(args.server) == 1:
            printer('📰 Mengambil informasi untuk server yang dipilih...', quiet)
        else:
            printer('🔎 Pemilihan server terbaik berdasarkan ping...', quiet)
    ...
    if args.share and not machine_format:
        printer('▶︎Hasil Gambar: %s' % results.share())
